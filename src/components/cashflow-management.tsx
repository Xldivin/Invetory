    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-white">{formatCurrency(totalInflow)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black-600">{formatCurrency(totalOutflow)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${netCashflow >= 0 ? 'text-gray-900 dark:text-white' : 'text-gray-900 dark:text-white'}`}>
